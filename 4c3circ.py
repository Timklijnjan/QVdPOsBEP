...
for fileparam in fileparamlist:
    ...
    qsave(ravg12,'3oscircravg12'+fileparam)
    qsave(ravg13,'3oscircravg13'+fileparam)
    qsave(ravg23,'3oscircravg23'+fileparam)"""

rV = [qload('3oscircravg23V5D1'),qload('3oscircravg23V100D1'),qload('3oscircravg23V20D20')]

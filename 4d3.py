...
for fileparam in fileparamlist:
    ...
    qsave(Savg1,'3osSavg12'+fileparam)
    qsave(Savg2,'3osSavg13'+fileparam)
    qsave(Savg3,'3osSavg23'+fileparam)"""

SavgV=[qload('3osSavg3V5D1'),qload('3osSavg3V100D1'),qload('3osSavg3V20D20')]
